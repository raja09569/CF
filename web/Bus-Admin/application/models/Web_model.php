...
class Web_model extends CI_Model {
	...
	public function check_mail($data){ 	
 	...
 	public function update_user($data){
 		...
 		$this->db->update('tbl_bus_user',$data);
 		return true;
 	}
 	...
 	public function log_user($data){
 		...
 		if (is_numeric($mobile)) {
			...
			$user= $this->db->get('tbl_bus_user')->row();
 		}
 		else{
 	...
 	public function bus_search($data){
		...
		$this->db->join('tbl_bus_drop_points g', 'g.drop_point=a.id', 'left');
    ...
    public function mail_details_bookingID( $data){
			...
			$this->db->join('tbl_bus_board_points g', 'g.board_point=f.id', 'left');
	...
	public function cancel_status($data){
		$this->db->where('id',$data['id']);
		$this->db->update('tbl_bus_booking_details',$data);
		return true;
