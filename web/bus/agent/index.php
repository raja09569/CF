...
<?php
	...
	if(isset($_POST['user_login'])){
		...
		if($username == ""){
			...
			$query = mysqli_query($conn, "select username from tbl_bus_agent where email='".$username."' and password='".$password."' and status='1'");
...
<div class="login-c1">
<div class="cpadding50">
<input type="email" name="user_name" class="form-control logpadding" placeholder="Username">
<br/>
...
<div class="right"><a href="agent_registration.php" class="whitelink">Register now</a></div>
</div>			
</div>
<!-- End of Login Wrap  -->
